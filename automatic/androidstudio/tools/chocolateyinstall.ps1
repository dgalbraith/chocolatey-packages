...
$url        = 'https://redirector.gvt1.com/edgedl/android/studio/install/2025.1.2.13/android-studio-2025.1.2.13-windows.exe'
$checksum   = '4437d3caf5b6d08b29c1012c17762bff22416a6d418a7aaf997c489a588dd750'
$silentArgs = '/S'
