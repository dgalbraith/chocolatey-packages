...
$url        = 'https://redirector.gvt1.com/edgedl/android/studio/install/2023.2.1.25/android-studio-2023.2.1.25-windows.exe'
$checksum   = 'ea891f977305dfaf58dfafed7908a6b14d7fdd9d2b024a80a13bd80b3a82c346'
$silentArgs = '/S'
