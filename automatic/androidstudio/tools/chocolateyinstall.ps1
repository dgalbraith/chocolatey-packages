...
$url        = 'https://redirector.gvt1.com/edgedl/android/studio/install/2025.2.1.8/android-studio-2025.2.1.8-windows.exe'
$checksum   = '27418da6706493e2a60f1da474723ad6d8ad4f20550357c085658b3f30bcb432'
$silentArgs = '/S'
