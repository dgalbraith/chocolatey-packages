...
$url        = 'https://redirector.gvt1.com/edgedl/android/studio/install/2024.3.2.15/android-studio-2024.3.2.15-windows.exe'
$checksum   = 'da717086ed055c9d91658fb973336d2973244874dd333c863e0236f98b6660d1'
$silentArgs = '/S'
