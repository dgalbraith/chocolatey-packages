...
$url        = 'https://redirector.gvt1.com/edgedl/android/studio/install/2023.3.1.20/android-studio-2023.3.1.20-windows.exe'
$checksum   = '395a5e17c8050f26a166b063ac7771f81c52e07f9b6f52cd16241796a48af188'
$silentArgs = '/S'
