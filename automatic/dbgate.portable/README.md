# [<img src="https://cdn.jsdelivr.net/gh/dgalbraith/chocolatey-packages@29da18f87fbac2bbe3e9321728c76c57dce0eb9a/icons/dbgate.png" width="48" height="48" />DbGate - The Smartest (no)SQL Database Client (Portable)](https://chocolatey.org/packages/dbgate.portable)
...
[![Software version](https://img.shields.io/badge/Source-v5.2.3-blue)](https://github.com/mongodb/mongocli/releases/tag/v5.2.3)
...
e.g. `choco install -y dbgate.portable --package-parameters="/AddToDesktop"`
* `/AddToStart` - add a shortcut to the start menu for DbGate.  By default the shortcut will be added for all users
e.g. `choco install -y dbgate.portable --package-parameters="/AddToStart"`
...
e.g. `choco install -y dbgate.portable --package-parameters="/AddToDesktop /User"`
