...
$unzipArgs = @{
  ...
  FileFullPath   = Join-Path $toolsDir 'Slik-Subversion-1.14.5-win32.zip'
  FileFullPath64 = Join-Path $toolsDir 'Slik-Subversion-1.14.5-x64.zip'
...
$packageArgs = @{
  PackageName    = $env:ChocolateyPackageName
  File           = Join-Path $toolsDir 'Slik-Subversion-1.14.5-win32.msi'
  File64         = Join-Path $toolsDir 'Slik-Subversion-1.14.5-x64.msi'
  FileType       = 'msi'
