...
function global:au_BeforeUpdate {
  ...
  $executable = Get-ChildItem -Recurse -Path $toolsDir 'sqlite?.exe'
  ...
  Get-ChildItem $executable.Directory -Recurse -Exclude ('*.ps1', 'sqlite?.exe') | Remove-Item -Force -ea 0 | Out-Null
}
