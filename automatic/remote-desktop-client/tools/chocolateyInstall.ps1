...
$packageArgs = @{
  ...
  FileType       = 'msi'
  Url            = 'https://res.cdn.office.net/remote-desktop-windows-client/45b6d21c-d3ad-4ab1-9098-a3d86d36042a/RemoteDesktop_1.2.7046.0_x86.msi'
  Checksum       = 'bc6cd34219acfb015ddd79687413c6da29040605a365564e0546fa735eab1ef8'
  ChecksumType   = 'sha256'
  Url64          = 'https://res.cdn.office.net/remote-desktop-windows-client/8d121bab-82e4-47eb-84e6-5db63086665a/RemoteDesktop_1.2.7046.0_x64.msi'
  Checksum64     = '82b39e13e36341ff479b5d1eb0014ee2dc6d1442c24b6c6937180289e5e81baf'
