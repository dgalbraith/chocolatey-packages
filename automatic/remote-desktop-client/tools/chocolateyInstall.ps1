...
$packageArgs = @{
  ...
  FileType       = 'msi'
  Url            = 'https://res.cdn.office.net/remote-desktop-windows-client/86a9284e-f74e-40ab-9d74-9ecd6134095b/RemoteDesktop_1.2.6597.0_x86.msi'
  Checksum       = '954feae52f4bcf2e2b8e09352ba659debfa138da8627b647c4cd66df4f839080'
  ChecksumType   = 'sha256'
  Url64          = 'https://res.cdn.office.net/remote-desktop-windows-client/90edc32b-248d-4173-af46-ed50623eb4d0/RemoteDesktop_1.2.6597.0_x64.msi'
  Checksum64     = 'bdef77e189c06c6a5fc044229b1cb874c818b564641502a20e7d8af7031bd95b'
