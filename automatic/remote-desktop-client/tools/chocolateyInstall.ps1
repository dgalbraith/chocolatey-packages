...
$packageArgs = @{
  ...
  FileType       = 'msi'
  Url            = 'https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RW1m3bi'
  Checksum       = 'd88654101dbe53cd300fb4edb02c5244e7d52bf10a3b5b59d7cc6fd80c368e54'
  ChecksumType   = 'sha256'
  Url64          = 'https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RW1m3bh'
  Checksum64     = '6cfba798cd2aff0b5ce97d3d262c8ff7a413023bc60db123d96456dcfd533a62'
