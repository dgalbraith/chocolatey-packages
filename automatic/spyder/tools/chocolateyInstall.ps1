...
$packageArgs = @{
  ...
  url64          = 'https://github.com/spyder-ide/spyder/releases/download/v6.1.3/Spyder-Windows-x86_64.exe'
  checksum64     = 'ea6bebb450540869c22ccdb330a754e5e246d613036edac6deca2470ae682757'
