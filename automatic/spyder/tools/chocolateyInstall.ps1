...
$packageArgs = @{
  ...
  url64          = 'https://github.com/spyder-ide/spyder/releases/download/v6.1.5/Spyder-Windows-x86_64.exe'
  checksum64     = '92005331137502c199fb9926501d5aeaec0e940cc54a69f1e3d0908473176472'
